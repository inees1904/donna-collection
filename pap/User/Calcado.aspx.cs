...
namespace pap.User
{
    public partial class Calcado : System.Web.UI.Page
    {
        ...
        private void LoadProducts()
        {
            ...
            string query = "SELECT p.produtoId, p.nomeProduto, p.preco, p.imagemUrl1 FROM Produto p WHERE p.categoria2 = 'Calçado' AND p.isActive = 1";
